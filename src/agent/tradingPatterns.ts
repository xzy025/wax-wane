...
export const TRADING_PATTERNS: TradingPattern[] = [
  // ===== 云聪交易模式 =====
  {
    id: 'yuncong-13-buy-points',
    name: '云聪13买点',
    category: 'teacher',
    description: '从底部反转、双突破、中继到大周期回调和多周期共振的13类买点',
    keyElements: [
      '买点1-4：2B、右肩50%、二次测试、强势出现',
      '买点5-7：趋势线+量能/点位/形态双突破',
      '买点8-10：大形态突破、回抽确认、顺势N字',
      '买点11-13：斐波回撤、弹簧/箱底、周期共振',
    ],
    analysisGuide: `## 云聪13买点分析要求
- 必须明确标注“买点编号 + 名称”，不可只写笼统的技术买点
- 依次判断当前处于底部反转、突破、中继、大周期回调还是加速阶段
- 双突破专指买点5/6/7：下降趋势线分别叠加量能累积、关键点位或形态边界突破；两根十字星不是通用硬条件
- 买点1严格要求阴线跌破小平台后，下一根K线立即以强阳实体反包并收回平台；第三、第四根才收回、跌破K不是阴线、仅收回但未实体反包，都不算严格2B
- 买点10优先视为已有盈利后的加仓点；买点13之后更接近止盈观察区
- 对波浪计数、量能累积线和多周期共振等无法从现有数据确认的部分，明确写“待人工确认/数据不足”
- 所有突破都要给出结构失效位，不能以课程名称替代止损`,
  },
  {
    id: '2b-buy',
    name: '2B买入模型',
